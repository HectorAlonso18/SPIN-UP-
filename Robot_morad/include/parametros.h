...
#define MEDIUM_FLYWHEEL_VELOCITY 2830
#define SHORT_FLYWHEEL_VELOCITY 2675

#define STOP_FLYWHEEL_VELOCITY 0

#define HIGH_VELOCITY_SHOOT 55
#define MEDIUM_VELOCITY_SHOOT 55
#define LOW_VELOCITY_SHOOT 15
